...
export async function rewriteDraft(
  ...
  const block = exemplarBlock ?? buildWriterExemplarBlock(ctx);
...
export async function generateFollowupEmail(
  ...
  // rewrite. grey forces the Sonnet writer for regulated verticals; the exemplar
  // block lifts every tier toward the doctrine bar.
