...
import { processDueFollowups, autoQueueAllCampaigns, stallDraftedFollowups, archiveStalePausedCampaigns } from "./services/scheduler";
...
export function startCronJobs(): void {
  ...
  logger.info("Cron jobs active: sync+auto-queue @*/15, process @5,20,35,50, draft-stall @00:30, archive-sweep @00:45, weekly-digest @Tue 00:00 UTC + retry @Tue 06:00 UTC, fast-tick @*/3");
}
