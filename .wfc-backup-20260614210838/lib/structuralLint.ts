...
const ACK_REF: Record<string, string[]> = {
  ...
  de: ["mail", "e-mail", "email", "nachricht", "zeilen"],
...
const ACK_VERB: Record<string, string[]> = {
  ...
  de: ["geschrieben", "gesendet", "gesandt", "melde mich", "komme zuruck", "anknupf", "bezugneh", "kontaktiert", "wollte mich"],
  ...
  zh: ["发过", "发送过", "写过", "写信", "联系您", "联系过", "跟进", "跟進", "提到", "提及", "联络您"],
  ko: ["보내", "드린", "연락", "후속"],
  ar: ["راسلت", "أرسلت", "كتبت", "تواصلت", "أتابع", "متابعة", "أعود", "اعود"],
  he: ["כתבתי", "שלחתי", "פניתי", "חוזר", "חזרתי", "פונה", "יצרתי קשר"],
  th: ["ส่งอีเมล", "ส่งข้อความ", "เขียนถึง", "ติดตามผล", "ติดตาม", "กลับมาติดตาม"],
...
const ACK_PRIOR: Record<string, string[]> = {
  ...
  es: ["anterior", "ultimo", "previo", "pasado", "nuevamente", "de nuevo"],
  pt: ["anterior", "ultimo", "previo", "novamente"],
  fr: ["precedent", "dernier", "anterieur", "a nouveau"],
  de: ["vorherig", "letzte", "fruher", "erneut", "noch einmal", "nochmals", "bereits"],
  it: ["precedente", "ultimo", "scorso", "di nuovo"],
  ru: ["предыдущ", "прошл", "ранее", "еще раз", "ещё раз", "снова", "повторно"],
  uk: ["попередн", "минул", "раніше", "ще раз", "знову"],
  ja: ["先日", "以前", "前回", "先ほど", "先般", "再度"],
  zh: ["此前", "之前", "上次", "上封", "上一封", "先前", "早前", "日前"],
