...
4. CONCISENESS: Is it 4-6 sentences maximum? No padding, no filler, no unnecessary repetition?

5. RELEVANCE: Does it relate back to the original email's topic without repeating the original pitch verbatim?

6. DIFFERENTIATION: Does it bring a genuinely new angle vs the original email and any previous follow-ups?

7. TONE: Professional but human? No corporate jargon, no spam signals? No AI-sounding words like "delve", "leverage", "seamless"?

OUTPUT FORMAT:
Return ONLY a JSON object:
{
  "scores": { "no_meta_language": 1-5, "followup_ack": 1-5, "language_match": 1-5, "conciseness": 1-5, "relevance": 1-5, "differentiation": 1-5, "tone": 1-5 },
  "overall": 1-5,
...
Set needs_rewrite to true if overall < 4 OR no_meta_language < 4 OR followup_ack < 4 OR language_match < 4. If no_meta_language is 1 or 2, needs_rewrite MUST be true — meta-language is the most serious failure mode. If followup_ack is 1 or 2, needs_rewrite MUST be true. If language_match is 1 or 2, needs_rewrite MUST be true.
Do not include any other text, markdown, or explanation.`;
}
