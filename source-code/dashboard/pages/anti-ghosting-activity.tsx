// AntiGhostingActivityLog — clone of context-activity.tsx retargeted to
// /api/anti-ghosting/campaign/status. Structural differences vs the
// Anti-Ghosting Activity Log: the label-field rename (context_label →
// anti_ghosting_label) and the product title. Everything else — types,
// helpers, polling cadence, rendering — mirrors the Context version.
...
interface UserActivity {
  ...
  // anti_ghosting_label (vs context_label) — the user's AntiGhosting Followuper Gmail label.
  anti_ghosting_label: string;
              ...
              <div className="px-5 pb-5 space-y-3" style={{ borderTop: "1px solid var(--border-default)", paddingTop: "16px" }}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <p className="text-[11px]" style={{ color: "var(--text-tertiary)" }}>
                    Max {user.max_followups} follow-ups · Label: <span className="font-mono">{user.anti_ghosting_label}</span>
                  </p>
                </div>
...
export default function AntiGhostingActivityLog() {
        ...
        <div className="space-y-3">
          ...
          {idleUsers.map((user, i) => (
            <motion.div
              ...
              initial={{ opacity: 0, y: 8 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: (activeUsers.length + i) * 0.05, duration: 0.2 }}
            >
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  <div
